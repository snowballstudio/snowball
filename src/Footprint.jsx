      ...
      {showFootprintInfo && (
        <section className="footprintInfoPage" aria-label="足迹说明">
          ...
          <div className="footprintInfoBody">
            <p>
              新增足迹时，可以先输入地名，再点击地图，把图钉放到更准确的位置。
              点击图钉或下方记录行查看历史足迹详情。去过次数越多，图钉越大。
            </p>
            ...
            <p>
              照片只保存原图索引和缩略图，不复制占用欸外储存空间，理论上数量不受限制。
              点击缩略图可回到相册查看原图，并可左右滑动浏览。
            </p>

            <p>
              查看原图时，可以放大照片；长按照片可以转发。原图如果从相册删除，索引也会失效。
            </p>
          </div>
        </section>
      )}
