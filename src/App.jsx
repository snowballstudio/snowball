...
const FOOD_ALIAS = {
  米饭: ['米饭', '白米饭', '大米', '白米', '炒饭', '蛋炒饭', '盖交饭', '糯米','寿司', '饭团', '粥',  '小米粥',  '皮蛋瘦肉粥',  '菜饭', '稀饭'],
  面食: ['面食', '面', '面条', '拉面', '牛肉拉面', '螺蛳粉', '肠粉','河粉','炒河粉','炒面','馒头', '包子', '小笼包','生煎','米线','饺子', '馄饨', '云吞','抄手','云吞面','小馄饨','意大利面','葱油饼','煎饼','意面', '披萨', '汉堡'],
  面包: ['面包', '吐司', '汉堡包', '切片', '菠萝包','肉松包', '白切面包', '三明治', '烤面包'],
  土豆: ['土豆', '马铃薯', '土豆泥','薯片','薯条'],
  薯类: ['红薯', '烤地瓜','山药','凉薯','芋艿','芋头','烤地瓜','地瓜'],
  其它主食: ['其它主食', '鸡蛋饼', '饼干',  '饼', '鸡蛋饼','汤饭','菜饭','皮带面','粉丝','宽粉','粉','鸭血粉丝','肉夹馍','手擀面','手撕饼'],
  蛋: ['鸡蛋', '蛋', '鸭蛋', '鹌鹑蛋', '煮鸡蛋', '水煮蛋', '煎蛋', '炒蛋', '番茄炒蛋', '煎鸡蛋', '荷包蛋'],
